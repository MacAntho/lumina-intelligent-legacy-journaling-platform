...
const router = createBrowserRouter([
  ...
  { path: "/dashboard", element: <AuthGuard><Dashboard /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
  { path: "/journal/:id", element: <AuthGuard><JournalDetail /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
  { path: "/insights", element: <AuthGuard><Insights /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
  { path: "/legacy", element: <AuthGuard><LegacySettings /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
  { path: "/activity", element: <AuthGuard><ActivityPage /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
  { path: "/profile", element: <AuthGuard><ProfilePage /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
  { path: "/ai-assistant", element: <AuthGuard><AIChat /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
  { path: "/settings", element: <AuthGuard><SettingsPage /></AuthGuard>, errorElement: <RouteErrorBoundary /> },
