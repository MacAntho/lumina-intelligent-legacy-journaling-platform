...
/**
 * Entity representing the authentication data and profile for a Lumina user.
 */
...
/**
 * Storage record for prompts generated by the AI engine.
 */
...
/**
 * Manages user usage metrics for tier enforcement.
 */
export class UsageEntity extends IndexedEntity<UsageStats & { id: string }> {
  ...
  /**
   * Fetches current usage and resets monthly counters if the month has changed.
   */
...
/**
 * Manages core user authentication and GDPR-compliant data purging.
 */
export class UserAuthEntity extends IndexedEntity<UserAuthData> {
  ...
  /**
   * Performs a comprehensive purge of all user-related data across all entities.
   */
...
/**
 * Manages user-created journals (Archives).
 */
...
/**
 * Manages individual journal entries (Reflections).
 */
...
/**
 * Manages AI-generated insights for specific journals.
 */
...
/**
 * Logs data export events for security auditing.
 */
...
/**
 * Logs access to shared legacy archives.
 */
...
/**
 * Logs critical security events (login, password reset, etc).
 */
